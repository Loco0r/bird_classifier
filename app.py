...
def predict():
    ...
    if file:
        img_path = f'C:/Users/recep/Desktop/Bird_classifier/web/static/uploads/{file.filename}'
        file.save(img_path)
